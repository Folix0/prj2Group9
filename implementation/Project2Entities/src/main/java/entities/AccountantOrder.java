...
public class AccountantOrder {
    ...
    public AccountantOrder(int orderId, int customerId, double amount, String destinationAddress, int destinationPostcode, String pickupAddress, LocalDate deliveryDate, boolean hazardous, String email, double totalPrice) {
